...
<div class="slider-area">
    <div class="slider-active owl-dot-style owl-carousel">
        <div class="single-slider ptb-240 bg-img"
            style="background-image:url(../../../1-NTI\ Ecommerce\ App/assets/img/slider/slider-1.jpg);">
            <div class="container">
        ...
        <div class="single-slider ptb-240 bg-img"
            style="background-image:url(../../../1-NTI\ Ecommerce\ App/assets/img/slider/slider-1-1.jpg);">
            <div class="container">
                <div class="slider-content slider-animated-1">
                    <h1 class="animated">Want to stay <span class="theme-color">healthy</span></h1>
                    <h1 class="animated">drink matcha.</h1>
        ...
        <div class="featured-product-active hot-flower owl-carousel product-nav">
            <div class="product-wrapper">
                <div class="product-img">
                    <a href="../product/product-details.php">
                ...
                <div class="product-content text-left">
                    <div class="product-hover-style">
                        <div class="product-title">
                            <h4>
                                <a href="../product/product-details.php">Nature Close Tea</a>
                            </h4>
                        </div>
                        <div class="cart-hover">
                            <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        </div>
                    </div>
            ...
            <div class="product-wrapper">
                ...
                <div class="product-content text-left">
                    <div class="product-hover-style">
                        <div class="product-title">
                            <h4>
                                <a href="../product/product-details.php">Pink wave Cup</a>
                            </h4>
                        </div>
                        <div class="cart-hover">
                            <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
            ...
            <div class="product-wrapper">
                ...
                <div class="product-content text-left">
                    <div class="product-hover-style">
                        <div class="product-title">
                            <h4>
                                <a href="../product/product-details.php">Tea and Chai</a>
                            </h4>
                        </div>
                        <div class="cart-hover">
                            <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
            ...
            <div class="product-wrapper">
                ...
                <div class="product-content text-left">
                    <div class="product-hover-style">
                        <div class="product-title">
                            <h4>
                                <a href="../product/product-details.php">Pearly Everlasting</a>
                            </h4>
                        </div>
                        <div class="cart-hover">
                            <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
            ...
            <div class="product-wrapper">
                ...
                <div class="product-content text-left">
                    <div class="product-hover-style">
                        <div class="product-title">
                            <h4>
                                <a href="../product/product-details.php">Que herbal Tea</a>
                            </h4>
                        </div>
                        <div class="cart-hover">
                            <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">BeBe Bloom tea</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Every spice Tea</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Society Ice Tea</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Green Tea Tulsi</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Best Friends Tea</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Instant Tea Premix</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Black Ossum Tea</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
                        ...
                        <div class="product-wrapper mb-30">
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        <h4>
                                            <a href="../product/product-details.php">Le Bongai Tea</a>
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="../product/product-details.php">+ Add to cart</a></h4>
