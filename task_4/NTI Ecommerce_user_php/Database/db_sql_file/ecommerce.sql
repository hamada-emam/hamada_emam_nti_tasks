...
CREATE TABLE `vrification` (
  `id` bigint(20) UNSIGNED NOT NULL, -- id 
  `vrified_at` timestamp NOT NULL DEFAULT current_timestamp(),, 
  `updated_verification_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
